...
import es.altair.hibernate.dao.DireccionDAO;
import es.altair.hibernate.dao.DireccionDAOImpleHibernate;
...
public class App 
{
    public static void main( String[] args )
    {
        ...
        DireccionDAO dirDAO = new DireccionDAOImpleHibernate();
